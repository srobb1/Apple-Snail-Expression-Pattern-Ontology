 ...
 * [ase.yml](ase.yml)
     * Determines how your purl.obolibrary.org/obo/ase/ redirects will be handled
     ...
     * Paste in the contents of [ase.yml](ase.yml)
 ...
 * [ase.md](ase.md)
     ...
     * Paste in the contents of [ase.md](ase.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
